...
if ($outlookProcess) {
    ...
    Write-Host "Luk venligst Outlook før installation fortsætter." -ForegroundColor Yellow
    Write-Host ""
...
if (-not (Test-Path $dllPath)) {
    ...
    Write-Host ""
    Write-Host "Byg venligst projektet først:" -ForegroundColor Yellow
    Write-Host "  1. Abn projektet i Visual Studio" -ForegroundColor White
...
try {
    # Fjern eksisterende nøgle hvis den findes
